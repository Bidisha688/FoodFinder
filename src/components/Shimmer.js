...
export default function Shimmer({ count = 12 }) {
  ...
  return (
    <>
      {items.map((_, i) => (
        <div key={i} className="rounded-2xl ring-1 ring-black/5 shadow-sm bg-white dark:bg-zinc-900 overflow-hidden animate-pulse">
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="h-4 w-1/2 rounded-md bg-zinc-100 dark:bg-zinc-800" />
