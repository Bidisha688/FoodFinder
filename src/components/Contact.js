      ...
      <div className="rounded-3xl bg-white dark:bg-zinc-900 ring-1 ring-black/5 shadow-sm p-8 sm:p-10">
        ...
        >
          <input
            ...
            className="block w-full rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-3 py-2 text-sm shadow-sm placeholder:text-zinc-400 focus:border-transparent focus:ring-2 focus:ring-indigo-500"
          />
          <input
            type="email"
